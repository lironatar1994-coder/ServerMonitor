...
- Keep the interface mature and high-contrast: charcoal navigation, a solid deep-teal summary band, strong type and aligned numeric tables. Avoid pale framing, decorative badges and repeated metric icons. Keep brief labels and functional accessible icons, real failures and measurement uncertainty; explanations open on demand.
