...
- Prefer icon-led compact rows and one shared metric legend over repeated prose. Keep short task labels, named accessible icons, real failure states and measurement uncertainty; put methodology and coverage detail behind hints or disclosures. Do not replace useful controls with unexplained symbols.
